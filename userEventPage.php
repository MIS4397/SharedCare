<?php
	...
	$sql = "SELECT * FROM events WHERE  Org_ID = '$eventID'";
...
<div data-role='none' class="random-detected two-column-two">
			<a data-role="none" class="button blue" href="javascript:history.go(-1);"><img id='buttonIcon' class="button-icon" src="images/lists/address_48.png"></img><em> Click to reserve a spot</em><strong>Press it!</strong></a>
</div>
</div>
