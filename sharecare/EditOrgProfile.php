<?php
	...
	$myOrgName=mysql_result($result,0,"Org_Name");
	echo $myOrgName;
?>
...
<form action="UpdateOrg.php" method="post">
	...
	<div data-role="fieldcontain">
		...
		<input type="text" name="address" value='<?php echo mysql_result($result, 0,"Org_Address");?>'>
	</div>
	<div data-role="fieldcontain">
		<label for="city">City:</label><br/>
		<input type="text" name="city" value='<?php echo mysql_result($result, 0,"Org_City");?>'>
	</div>
	<div data-role="fieldcontain">
		<label for="state">State:</label><br/>
		<input type="text" name="state" value='<?php echo mysql_result($result, 0,"Org_State");?>'>
	</div>
	<div data-role="fieldcontain">
		<label for="zip">Zip:</label><br/>
		<input type="text" name="zip" value='<?php echo mysql_result($result, 0,"Org_Zip");?>'>
	</div>
	<div data-role="fieldcontain">
	...
	<div data-role="fieldcontain">
		...
		<textarea name="type"><?php echo mysql_result($result, 0,"Org_Type");?></textarea> 
	</div>	
	<div data-role="fieldcontain">
