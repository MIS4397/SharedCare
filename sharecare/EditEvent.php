...
<div data-role="fieldcontain">
		...
		<textarea name="address"><?php echo mysql_result($result, 0,"Event_Address");?></textarea><br/>
</div>
<div data-role="fieldcontain">
		<label for="city">City :</label></br>
		<textarea name="city"><?php echo mysql_result($result, 0,"Event_City");?></textarea><br/>
</div>
<div data-role="fieldcontain">
		<label for="state">State :</label></br>
		<textarea name="state"><?php echo mysql_result($result, 0,"Event_State");?></textarea><br/>
</div>
<div data-role="fieldcontain">
		<label for="zip">Zip :</label></br>
		<textarea name="zip"><?php echo mysql_result($result, 0,"Event_Zip");?></textarea><br/>
</div>
<div data-role="fieldcontain">
		<label for="duties">Duties :</label></br>
		<textarea name="duties"><?php echo mysql_result($result, 0,"Event_Duites");?></textarea><br/>
</div>
<div data-role="fieldcontain">
		<label for="requirements" >Requirements :</label></br>
		<textarea name="requirements"><?php echo mysql_result($result, 0,"Event_Requirements");?></textarea><br/>
</div>
