<?php
	...
	//{
		...
		$to="christopher.hale.3@gmail.com";//$eventEmail;
		echo $to;
		$subject="Hey man!";//"Someone has expressed interest in your event!";//.$myeventname;
		$message="I am going to test this on gmail with a more generic message.";//'Hello!  I am very interested in attending your upcoming event';//.$myeventname."/n/nHere is my contact information: ".$firstName." ".$lastName." ".$email."/n/nPlease let me know if I need to complete any steps in order to attend./n/nThanks,/nThe ShareCare Team";
		
		$headers  = 'MIME-Version: 1.0' . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";

	// Additional headers
		$headers .= 'From: ShareCare <noreply@sharecare.optic5.com>' . "\r\n";
		$headers .= 'Bcc: chrisghale@yahoo.com' . "\r\n";
