<?php
	...
	$sql="SELECT Like_EventType, COUNT(*) FROM Likes WHERE Like_UserID='$myuserid' ORDER BY Like_EventType";
	$result=mysql_query($sql);
	$myfavoritetype=mysql_result($result,0, "Like_EventType");
	
	
	$sql2="SELECT * FROM Events WHERE Event_Type='$myfavoritetype' AND NOW() <= Event_Date";
